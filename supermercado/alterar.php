    ...
    <div class="container">
        ...
        <form method="POST" action="alterar1.php">
            <table border="0">
                ...
                $id = $_GET["id"];
                $query = mysqli_query($conexao, "select for_id, for_nome, for_cnpj, for_email, for_telefone FROM fornecedores WHERE for_id = '$id'") or die("Erro1000");
                ...
                while ($saida = mysqli_fetch_array($query)) {
                    ...
                    echo "<td><input type='text' name='cnpj' value='$cnpj'></td>";
