...
<body>
    ...
    <div class="container">
        ...
        <form method="post" action="processa2.php">
            ...
            <input type="text" id="nome_f" name="nome" required>

            <label for="telefone_f">TELEFONE:</label>
            <input type="text" id="telefone_f" name="telefone" required>

            <label for="cnpj">CNPJ:</label>
            <input type="text" id="cnpj" name="cnpj" required>

            <label for="email_f">E-MAIL:</label>
            <input type="text" id="email_f" name="email" required>
    ...
    <div class="nav-buttons">
        <a href="consulta_fornecedor.php"><button>Consultar banco de dados</button></a>
